    ...
    window.nekobakoClipboard = {
        ...
        initialize(dropZone) {
            ...
            this.pasteHandler = event => {
                if (!dropZone.isConnected || dropZone.offsetParent === null || event.clipboardData.files.length === 0) {
                    return;
                }
                ...
                const clipboardFiles = new DataTransfer();
                for (const file of event.clipboardData.files) {
                    clipboardFiles.items.add(file);
                }

                input.files = clipboardFiles.files;
    ...
    window.keyCapture = {
        ...
        keydownHandler: function (e) {
            ...
            if (this.dotNetHelper) {
                this.dotNetHelper.invokeMethodAsync('OnKeyDownFromJS', e.key, e.code, e.ctrlKey, e.shiftKey, e.altKey);
            }
        },
