...
public partial class AutocompleteIllustratorComponent : IAutocompleteComponent
{
    ...
    {
        AutocompleteData = (await _client.GetFromJsonAsync<AutocompleteMst[]>("autocomplete/illustrator.json"))!;
    }
...
#pragma warning restore CS4014
    ...
    private async Task OnValueChanged(string? value)
    {
        ...
        if (IsQuizPage)
        {
            ...
            await ClientState.Session!.hubConnection!.SendAsync("SendGuessChanged", Guess, GuessKind.Illustrator);
        }
