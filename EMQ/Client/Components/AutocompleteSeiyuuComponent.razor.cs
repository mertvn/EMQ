...
public partial class AutocompleteSeiyuuComponent : IAutocompleteComponent
{
    ...
    {
        AutocompleteData = (await _client.GetFromJsonAsync<AutocompleteMst[]>("autocomplete/seiyuu.json"))!;
    }
...
#pragma warning restore CS4014
    ...
    private async Task OnValueChanged(string? value)
    {
        ...
        if (IsQuizPage)
        {
            ...
            await ClientState.Session!.hubConnection!.SendAsync("SendGuessChanged", Guess, GuessKind.Seiyuu);
        }
